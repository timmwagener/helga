...
if (__name__ == '__main__'):
    ...
    #include_list
    include_list = ['sip', 'Queue', 'multiprocessing']
    ...
    #data_files_list
    data_files_list = [
        ('media', ['media/auto_droplet.ui']),
        ('lib', ['lib/__init__.py', 
                    'lib/convert_functionality.py',
                    'lib/droplet_process.py',
                    'lib/threads_functionality.py']),
        ('lib/gui', ['lib/gui/__init__.py', 'lib/gui/auto_droplet_list_widget.py'])
        ]
    ...
    setup(
        ...
        description = 'AutoDroplet',
        author = author_name,
        console = ['auto_droplet_loader.py'],
