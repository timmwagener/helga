...
print "loading Helga Versioning"
...
def findNewVersionsWithArtistName(self, version):
  ...
  globExpression = re.sub("_[0-9]{4}_", "_*_", globExpression)
  print "GLOBEXPRESSION: " + globExpression + " VERSION"
  # Substitute camera-version for * wildcard  
  globExpression = re.sub("_[a-z]{1}_", "_*_", globExpression)
  print "GLOBEXPRESSION: " + globExpression + " CAMERA"
  # Substitute artist initials for * wildcard
  globExpression = re.sub("(?:\\*_)[A-Za-z]{2}", "*_*", globExpression)
  print "GLOBEXPRESSION: " + globExpression + " ARTIST"
  ...
  frameNumberRegex = ".\\d+\\." # e.g.: ".000.", "_001.", ".1000."
