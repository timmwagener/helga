...
class CharMetadataContextMenu(QtGui.QMenu):
    ...
    def add_actions(self):
        ...
        self.mnu_metadata.setObjectName(self.objectName() +'_' +'mnu_metadata')
        ...
        self.mnu_geometry.setObjectName(self.objectName() +'_' +'mnu_geometry')
        ...
        self.mnu_visibility.setObjectName(self.objectName() +'_' +'mnu_visibility')
        ...
        self.mnu_selection.setObjectName(self.objectName() +'_' +'mnu_selection')
    ...
    def get_pynode_list_from_selected_indices(self):
        ...
        #clean_pynode_list
        clean_pynode_list = self.maya_functionality.remove_duplicate_pynodes(pynode_list)
    ...
    def select_nodes(self):
        ...
        #select
        self.maya_functionality.select_nodes(pynode_list)
    ...
    def select_nodes_with_namespace_and_attr(self, attr_name):
        ...
        #select
        self.maya_functionality.select_nodes_with_namespace_and_attr(pynode_list, attr_name)
    ...
    def set_visibility_on_nodes_with_namespace_and_attr(self, attr_name_list, visibility):
        ...
        for attr_name in attr_name_list:
            ...
            #set visibility
            self.maya_functionality.set_visibility_on_nodes_with_namespace_and_attr(pynode_list, attr_name, visibility = visibility)
    ...
    def delete_nodes(self):
        ...
        #delete
        self.maya_functionality.delete_nodes(pynode_list)
